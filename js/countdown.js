            ...
            defaults: e(
              {
                ...
                script: function (n) {
                  var t = n.startfrom,
                    ...
                    u = o.__i_designerCountdownInterval;
                  u && clearInterval(u);
                  var p = window.__i_designerCountdownIntervals || [],
                    v = [];
                  p.forEach(function (n) {
                    n.isConnected ||
                      (clearInterval(n.__i_designerCountdownInterval), v.push(n));
                  }),
                    p.indexOf(o) < 0 && p.push(o),
                    (window.__i_designerCountdownIntervals = p.filter(function (n) {
                  ...
                  a
                    ? ((o.__i_designerCountdownInterval = setInterval(f, 1e3)),
