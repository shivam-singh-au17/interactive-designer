/*! grapesjs-lory-slider - 0.1.5 */ ! function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("InteractiveDesigner")) : "function" == typeof define && define.amd ? define(["InteractiveDesigner"], t) : "object" == typeof exports ? exports["grapesjs-lory-slider"] = t(require("InteractiveDesigner")) : e["grapesjs-lory-slider"] = t(e.InteractiveDesigner)
}(this, function (e) {
    return function (e) {
        function t(s) {
        ...
        var l = {};
        return t.m = e, t.c = l, t.d = function (e, l, s) {
        ...
        t.default = function (e) {
            ...
            e.addType(u, {
                model: a.extend({
                    defaults: s({}, a.prototype.defaults, {
                        name: "Slider",
                        "slides-to-scroll": 1,
                    ...
                    isComponent: function (e) {
                        if (e.hasAttribute && e.hasAttribute(v)) return {
                            type: u
                        }
                    }
                }),
                view: n.extend({
                    init: function () {
                        ...
                        s.length || s.add('<div data-gjs-type="' + d + '">\n              <div data-gjs-type="' + p + '">' + t.slideEls + '</div>\n          </div>\n          <span data-gjs-type="' + c + '">' + t.prevEl + '</span>\n          <span data-gjs-type="' + f + '">' + t.nextEl + "</span>")
                    }
                })
            })
        }
        ...
        t.default = function (e) {
            ...
            e.addType(d, {
                model: a.extend({
                    ...
                    isComponent: function (e) {
                        if ((0, n.elHasClass)(e, t.classSlides)) return {
                            type: d
                        }
                    }
                }),
        ...
        t.default = function (e) {
            ...
            e.addType(i, {
                model: a.extend({
                    ...
                    isComponent: function (e) {
                        if ((0, n.elHasClass)(e, t.classSlide)) return {
                            type: i
                        }
                    }
                }),
        ...
        t.default = function (e) {
            ...
            e.addType(i, {
                model: a.extend({
                    ...
                    isComponent: function (e) {
                        if ((0, n.elHasClass)(e, t.classFrame)) return {
                            type: i
                        }
                    }
                }),
