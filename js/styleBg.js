!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports["style-bg-component"] = t())
    : (e["style-bg-component"] = t());
})(
                                        ...
                                        },
                                        {
                                          ...
                                          value: function () {
                                            ...
                                            return (
                                              ...
                                              !t.silent &&
                                                this.emit("handler:remove", a),
                                              (0, i.isFunction)(n) && n(this),
                                              ["el", "gp"].forEach(function (
                                                t
                                              ) {
                                                return (e[t] = 0);
                                              }),
                                        ...
                                        },
                                        {
                                          ...
                                          value: function () {
                                            var e = this,
                                              ...
                                              a = r.max,
                                              l = t.querySelector(
                                                "[data-toggle=handler-close]"
                                              ),
                                              c = t.querySelector(
                                                "[data-toggle=handler-color-c]"
                                              ),
                                              u = t.querySelector(
                                                "[data-toggle=handler-color-wrap]"
                                              ),
                                              s = t.querySelector(
                                                "[data-toggle=handler-color]"
                                              ),
                                              d = t.querySelector(
                                                "[data-toggle=handler-drag]"
                                              ),
                                              p = function (t) {
                                                var n =
                                                    arguments.length > 1 &&
                        ...
                        l = function (e, t, n) {
                          ...
                          return (
                            ["linear", "repeating-linear"].indexOf(e) >= 0 &&
                              r.indexOf(o) >= 0 &&
                              (o =
                                "center" === o ? "to right" : "to ".concat(o)),
                            ["radial", "repeating-radial"].indexOf(e) >= 0 &&
                              r.indexOf(o) >= 0 &&
                              (o = "circle at ".concat(o)),
                            n
                              ? ""
                                  .concat(e, "-gradient(")
                                  .concat(o, ", ")
                            ...
                            y &&
                              i.addType(y, {
                                create: function (e) {
                                  ...
                                  (a.className = "gp-container"),
                                    (a.style.width = "100%");
                                  var l = new (t())(
                                    o({ el: a }, n.grapickOpts)
                                  );
                                  return (
      ...
      return (
        (() => {
          ...
          var a = function (e) {
            ...
            c =
              'style="max-height: 16px; display: block; margin: 0 auto" viewBox="0 0 24 24"',
            u = "background-image",
            s = "__background-type",
            d = u,
            p = "".concat(d, "-color"),
          ...
          const y = function (n, r) {
            ...
            n.Styles.addBuiltIn("background", {
              ...
              properties: [
                ...
                var t;
                return (
                  (null === (t = y.propExtender) || void 0 === t
                    ? void 0
                    : t.call(y, e)) || e
                );
              }),
