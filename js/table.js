          ...
          755: function (e, t) {
            ...
            !(function (t, n) {
              ...
              var k = (function (e) {
                ...
                try {
                  L.apply((D = R.call(w.childNodes)), w.childNodes),
                  ...
                  return (
                    ...
                    ue(function (i, a, s, l) {
                      var u,
                        ...
                        g = !e || (!i && t) ? m : Ce(m, f, e, s, l),
                        v = n ? (o || (i ? e : h || r) ? [] : a) : g;
                      if ((n && n(g, v, s, l), r))
                        for (u = Ce(v, d), r(u, [], s, l), c = u.length; c--; )
                          (p = u[c]) && (v[d[c]] = !(g[d[c]] = p));
                      if (i) {
                        if (o || e) {
                          if (o) {
                  ...
                  function (e, t) {
                    S.fn[e] = function (n, r) {
                      ...
                      return (
                        ...
                        this.length > 1 &&
                          (P[e] || S.uniqueSort(o), q.test(e) && o.reverse()),
                        this.pushStack(o)
                      );
                    };
                  }
                      ...
                      o = {
                        ...
                        then: function (e, n, o) {
                          ...
                          return S.Deferred(function (r) {
                            t[0][3].add(a(0, r, v(o) ? o : $, r.notifyWith)),
                              t[1][3].add(a(0, r, v(e) ? e : $)),
                              t[2][3].add(a(0, r, v(n) ? n : B));
                          }).promise();
                        },
                        promise: function (e) {
              ...
              function Te(e, t, n, r, o) {
                for (
                  ...
                  if ((i = e[d]) || 0 === i)
                    if ("object" === C(i)) S.merge(f, i.nodeType ? [i] : i);
                    else if (Ce.test(i)) {
                      for (
              ...
              function Ie(e, t, n, r) {
                ...
                if (
                  m ||
                  (f > 1 && "string" == typeof h && !g.checkClone && He.test(h))
                )
                ...
                if (
                  ...
                  for (s = (a = S.map(xe(o, "script"), Re)).length; p < f; p++)
                    (u = o),
                      p !== d &&
                        ((u = S.clone(u, !0, !0)),
                  ...
                  if (s)
                    for (
                      c = a[a.length - 1].ownerDocument, S.map(a, qe), p = 0;
                      p < s;
                      p++
                    )
                      (u = a[p]),
              ...
              function ft(e, t, n) {
                ...
                for (
                  ...
                  if ((r = ft.prefilters[i].call(u, e, c, u.opts)))
                    return (
                      v(r.stop) &&
                        (S._queueHooks(u.elem, u.opts.queue).stop =
                          r.stop.bind(r)),
                      r
                    );
                return (
                    ...
                    if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(d))
                      ...
                      d))
                        l ||
                          ...
                          m && de([e], !0),
                          f.done(function () {
                            for (r in (m || de([e]), K.remove(e, "fxshow"), d))
                              S.style(e, r, d[r]);
                          })),
                          (l = pt(m ? g[r] : 0, r, f)),
                          r in g ||
                ...
                trigger: function (e, t, n, o) {
                  ...
                  if (
                    ...
                    3 !== n.nodeType &&
                      ...
                      ((e = e[S.expando]
                        ? e
                        : new S.Event(m, "object" == typeof e && e)).isTrigger =
                        o ? 2 : 3),
                      (e.namespace = g.join(".")),
                  ...
                  ajax: function (e, t) {
                    ...
                    function E(e, t, a, l) {
                      ...
                      u ||
                        ...
                        (T.statusText = (t || C) + ""),
                        p
                          ? g.resolveWith(h, [f, C, T])
                          : g.rejectWith(h, [T, C, b]),
                        T.statusCode(y),
                        (y = void 0),
                        c &&
                    ...
                    return (
                      ...
                      n.always(function () {
                        void 0 === i ? S(r).removeProp(o) : (r[o] = i),
                          e[o] &&
                            ((e.jsonpCallback = t.jsonpCallback), Vt.push(o)),
                          a && v(i) && i(a[0]),
                          (a = i = void 0);
                      }),
                      "script"
        ...
        (() => {
          ...
          var s = function () {
              var e = [
                {
                  attributes: {
                    class: "column-actions columns-operations",
                ...
                {
                  attributes: {
                    class: "row-actions rows-operations",
              ...
              return (
                (editor.getSelected().getAttributes()["colspan"] > 1 ||
                  editor.getSelected().getAttributes()["rowspan"] > 1) &&
                  e.push({
                    attributes: {
          ...
          function u(e, t, n, r) {
            ...
            e.components().forEach(function (o, i) {
              0 === i && e.props().hasHeaders
                ? o.components().add({ type: r }, { at: t })
                : o.components().add({ type: n }, { at: t });
            }),
            ...
            e.components().add(
              {
                type: n,
                components: a(
                  Array(e.components().at(0).components().length).keys()
                ).map(function () {
                  return { type: r };
                }),
              },
              ...
              o && e.set({ nRows: Number(e.props().nRows) + 1 });
          }
          function p(e, t) {
            var n =
          ...
          function f(e, t) {
            var n =
              arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            e.components().at(t).remove(),
              n && e.set({ nRows: Number(e.props().nRows) - 1 });
          }
          function d(e, t, n) {
            var r =
            ...
            if (o) {
              for (var i = [], a = 0; a < e.props().nColumns; a++)
                i.push({ type: n });
          ...
          function h(e) {
            var t = document.getElementById("nRows").value,
              n = document.getElementById("nColumns").value;
            if (t && n && t > 0 && n > 0) {
          ...
          function m(e, t, n, r) {
            ...
            if ($("ul#toolbar-submenu-" + e).length > 0)
              $(".toolbar-submenu").slideUp("slow"),
                $("ul#toolbar-submenu-" + e).slideDown("slow");
            else if (o && (o.is(n) || o.is(r))) {
              var i = o.parent();
              if (
                ($("." + t + "-operations .toolbar-submenu").length > 0 &&
                  $("." + t + "-operations .toolbar-submenu").slideUp("slow"),
                $("." + e + "-operations .toolbar-submenu").length > 0)
              ) {
                if (
                  "none" !=
                  $("." + e + "-operations .toolbar-submenu").css("display")
                )
                  return void $(
                    "." + e + "-operations .toolbar-submenu"
                  ).slideUp("slow");
                ...
                if ("rows" === e)
                  a =
                    ...
                    (o.collection.indexOf(o) + 1 ==
                    o.parent().components().length
                      ? 'style="display: none;"'
                      : "") +
                    '><i class="fa fa-arrows-h" aria-hidden="true"></i> Merge cell right</li>\n          </ul>\n          ';
                else {
                  var s = o.getAttributes()["rowspan"]
                    ? o.getAttributes()["rowspan"]
                    : 0;
                  a =
                    ...
                    (i.collection.indexOf(i) + s ==
                      i.parent().components().length || o.is(r)
                      ? 'style="display: none;"'
                      : "") +
          ...
          const y = function (e) {
              ...
              o()(function () {
                ...
                r.appendChild(i),
                  ...
                  o()(t.containerId ? t.containerId : document).on(
                    "click",
                    "li.table-toolbar-submenu-run-command",
                    function () {
                ...
                e.on("component:add", function (t) {
                  "customTable" === t.attributes.type &&
                    0 == t.components().length &&
                    e.runCommand("open-table-settings-modal", { model: t });
                }),
                e.on("component:selected", function (e) {
                  (e.get("type") != t.componentCell &&
                    e.get("type") != t.componentCellHeader) ||
                    e.set("toolbar", s()),
                    "customTable" == e.get("type") && e.set("toolbar", l(e));
                });
            },
            b = function (e, t) {
              ...
              e.addType("customTable", {
                ...
                model: {
                            ...
                            .forEach(function (e) {
                              e.components().forEach(function (e) {
                                ...
                                t &&
                                  ...
                                  (e
                                    .getClasses()
                                    .includes("table-cell-highlight")
                                    ? e.removeClass("table-cell-highlight")
                                    : e.addClass("table-cell-highlight"));
                              });
                            });
                        },
                      },
                          ...
                          e.getSelected()
                            ...
                            .forEach(function (e) {
                              e.components().forEach(function (e) {
                                var t = e.getStyle();
                                t &&
                                  (t.width && e.removeStyle("width"),
                                  t.height && e.removeStyle("height"),
                                  e
                                    .getClasses()
                                    .includes("table-cell-highlight") &&
                                    e.removeClass("table-cell-highlight"));
                  ...
                  createTable: function () {
                    var e = 46 * Number(this.props().nColumns),
                      n = e < 900 ? e : 900,
                      r = 22 * Number(this.props().nRows);
                    this.setStyle({ width: n + "px", height: r + "px" });
                    for (
                      var o = [], i = this.props().hasHeader, a = [], s = 0;
                      s < this.props().nColumns;
                      s++
                    )
                      o.push({ type: t.componentCell });
                    for (var l = 0; l < this.props().nRows; l++)
                      this.components().add(
                        { type: t.componentRow, components: o },
                        { at: -1 }
                      );
                    if (i) {
                      for (var u = 0; u < this.props().nColumns; u++)
                        a.push({ type: t.componentCellHeader });
                      this.components().add(
                        { type: t.componentRow, components: a },
                        { at: 0 }
                      );
                    }
                  },
                  columnsChanged: function (e, n, r) {
                    if (this.columnCount() !== n) {
                      var o = n - this.columnCount(),
                        i = Math.abs(n - this.columnCount());
                      if (o < 0)
                        for (var a = 0; a < i; a++)
                          p(this, this.getLastColumnIndex());
                      else
                        for (var s = 0; s < i; s++)
                          u(
                            this,
                            this.columnCount(),
                            t.componentCell,
                            t.componentCellHeader
                          );
                    }
                  },
                  rowsChanged: function (e, n, r) {
                    if (this.rowCount() !== n) {
                      var o = n - this.rowCount(),
                        i = Math.abs(n - this.rowCount());
                      if (o < 0)
                        for (var a = 0; a < i; a++)
                          f(this, this.getLastRowIndex());
                      else
                        for (var s = 0; s < i; s++)
                          c(
                            this,
                  ...
                  headerChanged: function (e, n, r) {
                    this.checkHeaderExists() != this.props().hasHeaders &&
                      d(this, t.componentRow, t.componentCellHeader);
                  },
            ...
            E = function (e) {
              ...
              n.add("table-show-columns-operations", function () {
                ...
                n.add("table-select", function (e) {
                  e.runCommand("core:component-exit"),
                    e.runCommand("core:component-exit");
                }),
                ...
                n.add("table-insert-column-left", function (e) {
                  var n = e.getSelected();
                  (n.is(t.componentCell) || n.is(t.componentCellHeader)) &&
                    (u(
                      n.parent().parent(),
                      n.collection.indexOf(n),
                      t.componentCell,
                      t.componentCellHeader,
                      !0
                    ),
                ...
                n.add("table-delete-row", function (e) {
                  ...
                  if (n.is(t.componentCell) || n.is(t.componentCellHeader)) {
                    ...
                    e.selectRemove(n);
                    var o = n.parent();
                    f(r, o.collection.indexOf(o), !0),
                      0 === r.components().length && r.parent().remove(r);
                  }
                }),
                n.add("table-delete-column", function (e) {
                  ...
                  if (n.is(t.componentCell) || n.is(t.componentCellHeader)) {
                    var r = n.parent().parent(),
                      o = n.collection.indexOf(n);
                    e.selectRemove(n),
                      p(r, o, !0),
                      r.components().every(function (e) {
                ...
                n.add("table-merge-cells-right", function (e) {
                  ...
                  if (n.is(t.componentCell) || n.is(t.componentCellHeader)) {
                    for (
                      var r = n.getAttributes()["colspan"]
                          ? n.getAttributes()["colspan"]
                          : 1,
                        i = n.collection.indexOf(n),
                        a = n.parent().collection.indexOf(n.parent()),
                        s = n.parent().parent(),
                        l =
                          n.getAttributes()["rowspan"] > 0
                    ...
                    n.addAttributes({ colspan: ++r }),
                      g(),
                      i + 1 == n.parent().components().length &&
                        o()("#button-merge-cells-right").hide();
                  }
                }),
                  ...
                  if (n.is(t.componentCell)) {
                    for (
                      var r = n.getAttributes()["colspan"]
                          ? n.getAttributes()["colspan"]
                          : 1,
                        i = n.getAttributes()["rowspan"]
                          ? n.getAttributes()["rowspan"]
                          : 1,
                        a = n.collection.indexOf(n),
                        s = n.parent().collection.indexOf(n.parent()) + i - 1,
                        l = n.parent().parent(),
                        u = 0;
                      u < r;
                      u++
                    ...
                    n.addAttributes({ rowspan: ++i }),
                      g(),
                      s + 2 == l.components().length &&
                        o()("#button-merge-cells-down").hide();
                  }
                }),
                    ...
                    for (
                      var r = n.getAttributes()["colspan"]
                        ...
                        i = n.getAttributes()["rowspan"]
                          ...
                          : 1,
                        a = n.collection.indexOf(n),
                        s = n.parent().collection.indexOf(n.parent()),
                        l = n.parent().parent(),
                        u = 0;
                      u < i;
                      u++
                      ...
                      for (var c = 0; c < r; c++)
                        (0 === u && 1 === r) ||
                          ...
                          l
                            ...
                            .components()
                            .add(
                              { type: t.componentCell },
                              { at: 0 === u ? a + 1 : a }
                            ));
                    n.setAttributes({ colspan: 1 }),
                      n.setAttributes({ rowspan: 1 }),
                      g(),
                      o()("#button-merge-cells-down").show(),
                      o()("#button-merge-cells-right").show();
                  }
                }),
                  ...
                  run: function (e, t) {
                    ...
                    e.Modal.open({
                      ...
                      content:
                        ...
                        r.model.props()["nColumns"] +
                        '" name="nColumns" id="nColumns" min="1">\n            </div>\n            <div>\n              <label for="nRows">Number of rows</label>\n              <input type="number" class="form-control" value="' +
                        r.model.props()["nRows"] +
                        '" name="nRows" id="nRows" min="1">\n            </div>\n          <div>\n          <input id="table-button-create-new" type="button" value="Create Table" data-component-id="' +
                        r.model.cid +
                        '">\n        ',
                    }).onceClose(function () {
                      (r.model.components() &&
                        0 !== r.model.components().length) ||
                        r.model.remove(),
                        n.stopCommand();
                    });
                  },
