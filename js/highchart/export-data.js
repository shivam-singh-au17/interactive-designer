...
(function (a) {
  ...
  p(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
    var f = a.isSafari,
      ...
      D = (a.dataURLtoBlob = function (a) {
        if (
          ...
          var m = c.atob(a[3]),
            v = new c.ArrayBuffer(m.length);
          v = new c.Uint8Array(v);
          for (var q = 0; q < v.length; ++q) v[q] = m.charCodeAt(q);
          a = new c.Blob([v], { type: a[1] });
    ...
    a = a.downloadURL = function (a, p) {
      var v = c.navigator,
        q = y.createElement("a");
      if ("string" === typeof a || a instanceof String || !v.msSaveOrOpenBlob) {
        a = "".concat(a);
        ...
        if (
          ...
          if (((a = D(a) || ""), !a)) throw Error("Failed to convert to blob");
        if ("undefined" !== typeof q.download)
          (q.href = a),
            (q.download = p),
            y.body.appendChild(q),
            q.click(),
            y.body.removeChild(q);
        else
          try {
            var m = c.open(a, "chart");
  ...
  p(
    ...
    function (a, p, c, y, W, P, m) {
      function f() {
        var b = this.getCSV(!0);
        R(
          S(b, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(b),
      ...
      function v() {
        var b =
          ...
          "</body></html>";
        R(
          S(b, "application/vnd.ms-excel") ||
            "data:application/vnd.ms-excel;base64," +
              z.btoa(unescape(encodeURIComponent(b))),
      ...
      function q(b) {
        var a = "",
          ...
          x = A(
            e.decimalPoint,
            "," !== e.itemDelimiter && b ? (1.1).toLocaleString()[1] : "."
          ),
          d = A(e.itemDelimiter, "," === x ? ";" : ","),
          c = e.lineDelimiter;
        g.forEach(function (b, e) {
          for (var u, n = b.length; n--; )
            (u = b[n]),
              "string" === typeof u && (u = '"' + u + '"'),
              "number" === typeof u &&
                "." !== x &&
                (u = u.toString().replace(".", x)),
              (b[n] = u);
          b.length = g.length ? g[0].length : 0;
          a += b.join(d);
          e < g.length - 1 && (a += c);
        });
        return a;
      ...
      function D(b) {
        var a = this.hasParallelCoordinates,
          g = this.time,
          ...
          p = [],
          K = [],
          t = this.options.lang.exportData,
          h = t.categoryHeader,
          m = t.categoryDatetimeHeader,
          v = function (a, d, g) {
            if (e.columnHeaderFormatter) {
              var l = e.columnHeaderFormatter(a, d, g);
              if (!1 !== l) return l;
            }
            return a
              ? a instanceof X
                ? b
                  ? {
                      columnTitle: 1 < g ? d : a.name,
                      topLevelColumnTitle: a.name,
                    }
                  : a.name + (1 < g ? " (" + d + ")" : "")
                : (a.options.title && a.options.title.text) ||
                  (a.dateTime ? m : h)
              : h;
          },
          T = function (a, b, d) {
            ...
            b.forEach(function (b) {
              var e = ((a.keyToAxis && a.keyToAxis[b]) || b) + "Axis";
              e = Y(d) ? a.chart[e][d] : a[e];
              g[b] = (e && e.categories) || [];
              l[b] = e && e.dateTime;
            });
            return { categoryMap: g, dateTimeValueAxisMap: l };
          },
          Z = function (a, b) {
        ...
        this.series.forEach(function (l) {
          var u = l.xAxis,
            ...
            f;
          if (
            !1 !== l.options.includeInDataExport &&
            ...
            for (f = 0; f < n; )
              (w = v(l, x[f], x.length)),
                K.push(w.columnTitle || w),
                b && p.push(w.topLevelColumnTitle || w),
                f++;
            var m = {
              chart: l.chart,
            ...
            l.options.data.forEach(function (b, c) {
              var w = { series: m };
              a && (h = T(l, x, c));
              l.pointClass.prototype.applyOptions.apply(w, [b]);
              var r = w.x;
              L(d[r]) &&
                d[r].seriesIndices.includes(m.index) &&
                ((b = Object.keys(d)
                  .filter(function (a) {
                    return d[a].seriesIndices.includes(m.index) && r;
                  })
                  .filter(function (a) {
                    return 0 === a.indexOf(String(r));
                  })),
                (r = r.toString() + "," + b.length));
              b = l.data[c] && l.data[c].name;
              f = 0;
              if (!u || "name" === l.exportKey || (!a && u && u.hasNames && b))
                r = b;
              k && (k[r] && (r += "|" + c), (k[r] = !0));
              d[r] || ((d[r] = []), (d[r].xValues = []));
              d[r].x = w.x;
              ...
              for (
                ...
                (c = x[f]),
                  ...
                  (d[r][B + f] = A(
                    h.categoryMap[c][b],
                    h.dateTimeValueAxisMap[c]
                      ? g.dateFormat(e.dateFormat, b)
                      : null,
                    b
                  )),
                  f++;
        ...
        for (f in d) Object.hasOwnProperty.call(d, f) && n.push(d[f]);
        t = b ? [p, K] : [K];
        for (B = q.length; B--; ) {
          var k = q[B][0];
          var M = q[B][1];
          var C = c[k];
          n.sort(function (a, b) {
            return a.xValues[k] - b.xValues[k];
          });
          var f = v(C);
          t[0].splice(M, 0, f);
          b && t[1] && t[1].splice(M, 0, f);
            ...
            C &&
              ...
              (C.dateTime
                ? (a.x instanceof Date && (a.x = a.x.getTime()),
                  (b = g.dateFormat(e.dateFormat, a.x)))
                : (b = C.categories
                    ? A(C.names[a.x], C.categories[a.x], a.x)
                    : a.x));
            a.splice(M, 0, b);
          });
        }
      ...
      function ba(a) {
        var b = 0,
          ...
          d = A(e.exporting.useMultiLevelHeaders, !0);
        a = this.getDataRows(d);
        var n = d ? a.shift() : null,
          h = a.shift(),
          m = function (a, b, c, e) {
            var d = A(e, "");
              ...
              for (k = []; g < c; ++g) {
                ...
                n === h
                  ...
                  : (n === b[g]
                    ...
                    1 < h &&
                      n.attributes &&
                      ((n.attributes.valign = "top"),
                      (n.attributes.rowspan = h)),
                    k.push(n));
              }
            ...
            if (b) {
              ...
              for (c = b.length; g < c; ++g)
                "undefined" !== typeof b[g] &&
                  k.push(m("th", null, { scope: "col" }, b[g]));
              u.push({ tagName: "tr", children: k });
            }
            return { tagName: "thead", children: u };
          })(n, h, Math.max(b, h.length))
        );
        var p = [];
        a.forEach(function (a) {
          for (var c = [], d = 0; d < b; d++)
            c.push(m(d ? "td" : "th", null, d ? {} : { scope: "row" }, a[d]));
          p.push({ tagName: "tr", children: c });
        });
        c.push({ tagName: "tbody", children: p });
        c = {
          tree: {
            tagName: "table",
      ...
      function da(b) {
        var c = (b = A(b, !this.isDataTableVisible)) && !this.dataTableDiv;
        c &&
          ((this.dataTableDiv = ea.createElement("div")),
      ...
      function S(a, c) {
        ...
        try {
          ...
          if (!e)
            return f.createObjectURL(new z.Blob(["\ufeff" + a], { type: c }));
        } catch (n) {}
      }
      function ha() {
        var a = this,
        ...
        if (c && a.options.exporting && a.options.exporting.allowTableSorting) {
          var e = c.querySelector("thead tr");
          e &&
            e.childNodes.forEach(function (b) {
              var d = b.closest("table");
              b.addEventListener("click", function () {
                var e = E([], c.querySelectorAll("tr:not(thead tr)"), !0),
                  f = E([], b.parentNode.children, !0);
                e.sort(
                  g(
                    f.indexOf(b),
      ...
      var E =
          ...
          function (a, c, f) {
            if (f || 2 === arguments.length)
              for (var b = 0, g = c.length, d; b < g; b++)
                (!d && b in c) ||
                  (d || (d = Array.prototype.slice.call(c, 0, b)),
                  (d[b] = c[b]));
      ...
      return {
        compose: function (a) {
          -1 === h.indexOf(a) &&
            ...
            (a.getTableAST = ba),
            (a.hideData = ca),
            (a.toggleDataTable = da),
            (a.viewData = fa));
          if (-1 === h.indexOf(O)) {
            h.push(O);
            if ((a = ja().exporting))
              U(a.menuItemDefinitions, {
                downloadCSV: {
                  textKey: "downloadCSV",
                  onclick: function () {
                    this.downloadCSV();
          ...
          F &&
            -1 === h.indexOf(F) &&
            (h.push(F), (F.prototype.keyToAxis = { low: "y", high: "y" }));
          G &&
            -1 === h.indexOf(G) &&
            (h.push(G), (G.prototype.keyToAxis = { start: "x", end: "x" }));
          H &&
            -1 === h.indexOf(H) &&
            (h.push(H), (H.prototype.exportKey = "name"));
          I &&
            -1 === h.indexOf(I) &&
            (h.push(I), (I.prototype.exportKey = "name"));
          J &&
            -1 === h.indexOf(J) &&
            (h.push(J), (J.prototype.exportKey = "name"));
        },
      };
    }
  );
